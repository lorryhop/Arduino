...
//char INSERT_SQL[] = "INSERT INTO *****.*****(pw, name) VALUES (%s, %s)";    // 쿼리 입력
//char INSERT_SQL[] = "INSERT INTO kevin1217.tempnhumi(temp, humi) VALUES (30, 99)";    // 쿼리 입력
char INSERT_SQL[] = "INSERT INTO kevin1217.tempnhumi(temp, humi) VALUES (%s, %s)";    // 쿼리 입력
char query[128];
byte mac_addr[] = { 0xDE, 0xAD, 0xBE, 0xEF, 0xFE, 0xED };
 
IPAddress server_addr(183,111,174,96);  // DB주소
