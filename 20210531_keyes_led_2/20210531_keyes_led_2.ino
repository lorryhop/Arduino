...
void setup() 
{
  ...
  //RTC 설정
  myDS1302.halt(false);           //DS1302 동작 시작
  //myDS1302.halt(true);          //DS1302 대기 모드로 동작
  
  myDS1302.writeProtect(false);   //데이터 쓰기 동작
  //myDS1302.writeProtect(true);  //데이터 쓰기 금지

  //초기 1회 셋팅
  myDS1302.setDOW(THURSDAY);      //요일 기록 : MONDAY ~ SUNDAY
  myDS1302.setDate(6,22,2021);     //날짜 기록 : dd/mm/yyyy
  myDS1302.setTime(11,50,00);     //시간 기록 : hh/mm/ss (※ 24시간 단위)
